...
lazy val transformation = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      "software.amazon.smithy" % "smithy-build" % "1.59.0",
      "software.amazon.smithy" % "smithy-syntax" % "1.59.0",
      "ch.epfl.scala" % "spec-traits" % "2.2.0-M2",
      "tech.neander" % "jsonrpclib-smithy" % "0.0.8+51-32e30ec0-SNAPSHOT",
      ...
      "software.amazon.smithy" % "smithy-diff" % "1.59.0" % Test,
    ),
    publish / skip := true,
...
lazy val codegen = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "tech.neander" % "jsonrpclib-smithy" % "0.0.8+51-32e30ec0-SNAPSHOT" % Smithy4s,
...
lazy val bsp4s = project
  .settings(
    commonSettings,
    libraryDependencies ++= Seq(
      "tech.neander" %%% "jsonrpclib-smithy4s" % "0.0.8+51-32e30ec0-SNAPSHOT",
...
lazy val examples = project
  .settings(
    ...
    commonSettings,
    libraryDependencies ++= Seq(
      "tech.neander" %%% "jsonrpclib-fs2" % "0.0.8+51-32e30ec0-SNAPSHOT",
