...
lazy val protocol = project
  .settings(
    ...
    crossPaths := false,
    libraryDependencies ++= Seq(
      "software.amazon.smithy" % "smithy-model" % "1.65.0"
    ),
...
lazy val transformation = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      "software.amazon.smithy" % "smithy-build" % "1.65.0",
      "software.amazon.smithy" % "smithy-syntax" % "1.65.0",
      ...
      "software.amazon.smithy" % "smithy-diff" % "1.65.0" % Test,
    ),
    publish / skip := true,
  )
  .dependsOn(protocol)
