...
lazy val transformation = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "tech.neander" % "jsonrpclib-smithy" % "0.0.8+52-1450d867-SNAPSHOT",
...
lazy val codegen = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "tech.neander" % "jsonrpclib-smithy" % "0.0.8+52-1450d867-SNAPSHOT" % Smithy4s,
...
lazy val bsp4s = project
  .settings(
    commonSettings,
    libraryDependencies ++= Seq(
      "tech.neander" %%% "jsonrpclib-smithy4s" % "0.0.8+52-1450d867-SNAPSHOT",
...
lazy val examples = project
  .settings(
    ...
    commonSettings,
    libraryDependencies ++= Seq(
      "tech.neander" %%% "jsonrpclib-fs2" % "0.0.8+52-1450d867-SNAPSHOT",
