...
lazy val transformation = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "tech.neander" % "jsonrpclib-smithy" % "0.0.8+49-7dd4ecdb-SNAPSHOT",
...
lazy val codegen = project
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "tech.neander" % "jsonrpclib-smithy" % "0.0.8+49-7dd4ecdb-SNAPSHOT" % Smithy4s,
...
lazy val examples = project
  .settings(
    ...
    commonSettings,
    libraryDependencies ++= Seq(
      "tech.neander" %%% "jsonrpclib-fs2" % "0.0.8+49-7dd4ecdb-SNAPSHOT",
